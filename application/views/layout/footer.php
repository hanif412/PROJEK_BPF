        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="first-item">
                    ...
                    <ul>
                        <li><a href="#">Jalan Berdikari Gang Lestari No. 149, Rumbai, Pekanbaru, Riau, Indonesia</a></li>
                        <li><a href="#">goodgamingshop@company.com</a></li>
                        <li><a href="#">0888 8888 8888</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-3">
            ...
            <div class="col-lg-12">
                <div class="under-footer">
                    <p>Copyright © 2022 Good Gaming Shop Co., Ltd. All Rights Reserved.
